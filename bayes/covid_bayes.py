...
cpt["socially_disadvantaged"] = bayes.any(bayesianNetwork,cpt,
{
...
cpt["smoking"] = bayes.any(bayesianNetwork,cpt,
{
...
cpt["substance_abuse"] = bayes.any(bayesianNetwork,cpt,
{
...
cpt["stress"] = bayes.any(bayesianNetwork,cpt,
{
...
cpt["other_comorbidities"] = bayes.any(bayesianNetwork,cpt,
{
...
cpt["covid_symptoms"] = bayes.any(bayesianNetwork,cpt,
{
...
cpt["social_distancing"]= bayes.any(bayesianNetwork,cpt,
{
...
cpt["wearables"] = bayes.any(bayesianNetwork,cpt,
{
...
cpt["possible_dehydration"] = bayes.any(bayesianNetwork,cpt,
{
"low_urine":{"low_urine"},
"vomiting":{"vomiting"},
...
cpt["possible_meningitis"] = bayes.any(bayesianNetwork,cpt,
...
cpt["serious_shortness_of_breath"] = bayes.any(bayesianNetwork,cpt,
...
cpt["covid_vulnerabilities"] = bayes.any(bayesianNetwork,cpt,
	{
...
cpt["low_covid"] = bayes.any(bayesianNetwork,cpt,
	{
...
cpt["medium_covid"]= bayes.any(bayesianNetwork,cpt,
	{
...
cpt["high_covid"] = bayes.any(bayesianNetwork,cpt,
	{
	"cough":{"cough_up_blood"},
	"muscle_weakness":{"muscle_weakness_cant_move"},
	"low_oxygen_symptoms":{"have_low_oxygen_symptoms"},
	"covid vulnerabilities": {"severe_covid_vulnerabilites"}
	},
	["high_covid","other_covid"]
	)
	
	
cpt["covid_environment"] = bayes.any(bayesianNetwork,cpt,
	{
...
cpt["covid_symptom_level"] = bayes.if_then_else(bayesianNetwork,cpt,
	{
...
cpt["untreated_blood_pressure"] = bayes.any(bayesianNetwork,cpt,
	{
...
cpt["untreated_diabetes"] = bayes.any(bayesianNetwork,cpt,
	{
...
cpt["metabolic_disease"] = bayes.if_then_else(bayesianNetwork,cpt,
	{
...
cpt["emergency_treatment"] = bayes.any(bayesianNetwork,cpt,
{
...
cpt["covid_risk"] = bayes.any(bayesianNetwork,cpt,
	{
...
cpt["covid_severity"] = bayes.any(bayesianNetwork,cpt,
	{
...
bayes.addCpt(bayesianNetwork,cpt)
id = bayes.initialize(bayesianNetwork)
