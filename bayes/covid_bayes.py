...
cpt["socially_disadvantaged"] = bayes.avg(
{
...
cpt["other_comorbidities"] = bayes.any(
{
...
cpt["social_distancing"]= bayes.avg(
{
...
cpt["possible_dehydration"] = bayes.any(
{
"low_urine":{"low_urine"},
"vomiting":{"vomiting"},
...
cpt["covid_vulnerabilities"] = bayes.avg(
	{
...
cpt["covid_environment"] = bayes.avg(
	{
...
cpt["covid_symptom_level"] = bayes.if_then_else(
	{
...
cpt["untreated_blood_pressure"] = bayes.all(
	{
...
cpt["untreated_diabetes"] = bayes.all(
	{
...
cpt["metabolic_disease"] = bayes.if_then_else(
	{
...
cpt["emergency_treatment"] = bayes.any(
{
